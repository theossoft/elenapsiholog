...
В боте у Елены на новой заявке появятся кнопки «Подтвердить» и «Отменить». Команда `/pending` показывает заявки в ожидании. Если бота откроет клиент, он увидит ссылку на сайт и личный Telegram.
