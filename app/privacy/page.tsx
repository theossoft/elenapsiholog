  ...
  return (
    <article className="mx-auto max-w-3xl px-5 py-16 leading-relaxed">
      ...
      <ul className="mt-2 list-disc pl-5">
        <li>имя, телефон, Telegram и текст запроса — если вы оставляете заявку;</li>
        <li>технические данные визита (cookies Метрики) — только после согласия.</li>
      </ul>
      <h2 className="font-serif mt-8 text-2xl">Зачем</h2>
      <p className="mt-2">
        Чтобы связаться с вами, подтвердить время сессии и вести запись. Правовое
        основание — ваше согласие при отправке формы.
      </p>
      ...
      <p className="mt-2">
        ...
        Telegram-бот оператора. Яндекс.Метрика обрабатывает обезличенную статистику при
        вашем согласии.
      </p>
